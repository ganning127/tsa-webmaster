...
import { BsCalculator, BsBarChart, BsPersonFill } from "react-icons/bs";
...
const LinkItems = [
  ...
  { name: "Mentor Contact", icon: BsPersonFill, href: "/dashboard/mentor" },
];
  ...
  return (
    ...
    >
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        <Img src="/logo.png" h="12" display="inline" mr="3" mt="-1" />
  ...
  return (
    ...
    >
      <Flex
        ...
        cursor="pointer"
        fontWeight="semibold"
        bg={active === children.toLowerCase() ? "green.dark" : "transparent"}
        color={active === children.toLowerCase() ? "white" : "gray.800"}
        transition="all 0.2s"
        _hover={{
          bg: "green.dark",
          color: "white",
